...
Gizmo AI Unlimited Hearts operates entirely inside your browser. It injects a CSS rule and a DOM observer on `https://app.gizmo.ai/quiz/*` pages to hide a modal element. That is the full extent of what it does.
...
- Load any remote code, scripts, or resources after installation
- Contact any third-party analytics, advertising, or telemetry service

## Data sharing and sale

There is no data to share or sell. The extension has no backend, no database, and no network activity of any kind. Your data stays in your browser because nothing is ever taken out of it.
...
If the extension ever changes in a way that affects data handling, this policy will be updated and the version number in the header will change. The current version (v0.2.0) collects no data.
